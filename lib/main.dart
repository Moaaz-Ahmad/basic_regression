...
class _MyHomePageState extends State<MyHomePage> {
  ...
  String result = "This is the predicted result";
  MLService? mlService;
  ...
  Future<void> loadModel() async {
    try {
      ...
      // Leave mlService null and show a friendly message if used.
      mlService = null;
    }
  }
      ...
      body: Center(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            ElevatedButton(
                onPressed: performPrediction, child: const Text("Predict")),
            Text(
              result,
